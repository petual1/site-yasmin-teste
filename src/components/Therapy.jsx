...
const Therapy = () => {
  ...
  // -jsx-
  return (
    <section id="terapia" className="py-24 md:py-32 relative bg-yasmin-olive text-yasmin-base overflow-hidden w-full max-w-[100vw]">
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-32 text-center lg:text-left">
            ...
            <p className="text-yasmin-base/80 text-lg md:text-xl font-light leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
            ...
            <div className="mb-12 p-6 border-l-2 border-yasmin-cream/30 bg-white/5 rounded-r-2xl text-left">
              <p className="font-serif italic text-xl text-yasmin-cream text-center lg:text-left">
            ...
            <a 
              href="#contato"
              className="inline-flex items-center gap-3 bg-yasmin-cream text-yasmin-olive px-10 py-4 rounded-full font-semibold hover:bg-white transition-all duration-300 shadow-lg hover:-translate-y-1 mx-auto lg:mx-0"
            >
          ...
          <div className="space-y-8 mt-8 lg:mt-0">
             {benefits.map((item, idx) => (
               <div 
                 ...
                 className="group flex flex-col md:flex-row gap-6 p-8 rounded-[2rem] border border-white/10 bg-white/5 hover:bg-white/10 hover:border-yasmin-cream/30 transition-all duration-500 backdrop-blur-sm items-center md:items-start text-center md:text-left"
               >
                 <div className="flex-shrink-0">
                   <div className="w-16 h-16 rounded-2xl bg-yasmin-base/10 text-yasmin-cream flex items-center justify-center group-hover:bg-yasmin-cream group-hover:text-yasmin-olive transition-colors duration-500">
                     {item.icon}
                   </div>
                 </div>
                 
                 <div>
                   <h3 className="text-2xl font-serif mb-3 text-white group-hover:text-yasmin-cream transition-colors">
                     {item.title}
                   </h3>
                   <p className="text-yasmin-base/70 font-light leading-relaxed text-lg">
                     {item.desc}
                   </p>
                 </div>
               </div>
